...
import com.sergiofah.utils.SafeUsbRequest;
...
public class PL2303SerialDevice extends UsbSerialDevice
{
    ...
    private boolean openPL2303()
    {
        ...
        if (device.getVendorId() == 1659 && device.getProductId() == 9123) {
            Log.i(CLASS_ID, "Detectado dispositivo customizado 067B:23A3 (1659:9123) - usando sequ�ncia espec�fica");
            return initializeCustomDevice();
        } else {
            Log.i(CLASS_ID, "Usando sequ�ncia padr�o PL2303");
            return initializeStandardPL2303();
        }
    }

    private boolean initializeCustomDevice() {
        Log.d(CLASS_ID, "Iniciando sequ�ncia de inicializa��o para dispositivo 067B:23A3 (1659:9123)");
        ...
        if (result < 0) {
            ...
            // N�o retornar false ainda, tentar outros comandos
        }
        ...
        if (result < 0) {
            Log.e(CLASS_ID, "SET_LINE_CODING falhou - cr�tico");
            return false;
        }

        Log.d(CLASS_ID, "Testando comandos vendor b�sicos...");
        ...
        Log.i(CLASS_ID, "Inicializa��o customizada conclu�da com sucesso");
        return true;
    }
